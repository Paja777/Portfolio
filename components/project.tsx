...
export default function Project({
  ...
  const gitlink = title.includes("Find")
    ? "https://github.com/Paja777/FindHandyman"
  ...
  return (
    ...
    >
      <section
        className=" bg-gray-100 sm:group:even:pl-8 max-w-[42rem] border-black/5 overflow-hidden sm:pr-8 
    relative sm:h-[20rem] rounded-lg hover:bg-gray-200 dark:bg-white/10 dark:hover:bg-white/20 dark:text-white"
      >
        <div
          className="pt-4 pb-8 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem] 
