...
import image1 from "@/public/Novaslikaa.jpg";
...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      className="mb-28 max-w-[50rem] rext-center sm:mb-0 scroll-mt-28"
      id="home"
    >
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/paja-rvovic"
          target="_blank"
        >
          <BsLinkedin />
        </a>
