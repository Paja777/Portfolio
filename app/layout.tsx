...
export const metadata = {
  title: "Pavle Rvovic Portfolio",
  description: "Pavle is junior frontend developer.",
};
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        ...
        rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] leg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-[#676394]"
        ></div>
        <div></div>
